...
$consulta=mysqli_query($conexion,"select * from f_aplazamiento where $filtrar='$palabra'") or die;
$consulta1=mysqli_query($conexion,"select * from f_desercion where $filtrar='$palabra'") or die;
$consulta2=mysqli_query($conexion,"select * from f_c_jornada where $filtrar='$palabra'") or die;
$consulta3=mysqli_query($conexion,"select * from f_traslado where $filtrar='$palabra'") or die;
$consulta4=mysqli_query($conexion,"select * from f_retiro where $filtrar='$palabra'") or die;
$consulta5=mysqli_query($conexion,"select * from f_reingreso where $filtrar='$palabra'") or die ("el usuario no presenta ninguna novedad");	 	 	
...
if ($contador==0 )
{
echo "<tr bg-danger><td >El Aprendiz con el numero de documento <br> no presenta ninguna novedad</td></tr>";
exit;
}
