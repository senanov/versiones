...
$conexion=mysqli_connect("127.0.0.1","root","","proyecto") or die ("problemas en la conexion");
	 ...
	 $consulta=mysqli_query($conexion," update f_retiro SET nombre = '$nombres', apellidos = '$apellidos', documento = '$tdocumento', numero_documento = '$documento', grupo = '$grupo', numero_ficha = '$ficha', trimestre = '$trimestre', jornada = '$jornada', programa_formacion = '$programa', sede = '$sede', fecha = '$fecha', motivo = '$motivo' WHERE f_retiro. numero_documento = '$valor'")or die ("problema en el registro". mysqli_error());
	
	$reg=mysqli_fetch_array($consulta);
$_SESSION['documento']=$documento;

mysqli_close($conexion);
header('location:mostrar_retiro.php');
