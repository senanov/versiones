...
$conexion=mysqli_connect("127.0.0.1","root","","proyecto") or die ("problemas en la conexion");
	...
	$consulta=mysqli_query($conexion,"select * from f_reingreso where numero_documento='$documento'") or die ("problema en el registro". mysqli_error());
...
<?php 
                     if ($documento!=$reg['numero_documento'] ||$documento== "" ) {
                     	...
                     	echo '<form action="encontrar.php" method="post" >
			...
			<div class="col">
				...
				<table class="table table-bordered table-striped table-hover table-reponsive">
					...
					<tr class=" bg-info">
						...
						if ($_SESSION['roles']!='invitado') 
						{
						echo'<td class="td"><a href="modificar_reingreso.php"><input id="ip" type="button" value="Editar"></a> | <a href="borrar_reingreso.php"><input id="ipe" type="button" value="Eliminar"></a></td>';
					    }
					    ?>
