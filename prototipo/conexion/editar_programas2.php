...
$consulta=mysqli_query($conexion,"select * from especializaciones where codigo='$id'") or die("el usuario no presenta ninguna novedad");
		...
		<div class="row">
			<div class="col">
				...
				<table class="table table-bordered table-striped table-hover table-reponsive">
					...
					$var=$reg['especializacion'];
					
					echo '<tr class=" bg-info">'
                         .'<form action="editar_programas_general.php? codigo=3" method="post" >'
						.'<td>'."<input type='text' name='nuevo' size='70' value='$var'>".'</td>';
						
						
						echo '<input  type="hidden" name="valor" value='.$id.'>';
						
						 	echo'<td class="td"> <input id="ip" type="submit" name="enviar" value="continuar"> <a href="editar_programas_general.php? id2=6"><input id="ipe" type="button" value="Eliminar"></a>';
