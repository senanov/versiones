			...
			<div class="col">
				...
				<table class="table table-bordered table-striped table-hover table-reponsive">
					...
					<tr class=" bg-info">
						...
						if ($_SESSION['roles']!='invitado')
						{
						 	echo'<td class="td"> <a href="editar_aplazamiento.php"><input id="ip" type="button" value="Editar"></a> | <a href="eliminar_aplazamiento.php"><input id="ipe" type="button" value="Eliminar"></a>" </td>';
						} 
						?> 
