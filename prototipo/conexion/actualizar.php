...
$consulta=mysqli_query($conexion," update f_desercion SET nombre = '$nombres', apellidos = '$apellidos', documento = '$tdocumento', numero_documento = '$documento', grupo = '$grupo', numero_ficha = '$ficha', trimestre = '$trimestre', jornada = '$jornada', programa_formacion = '$programa', sede = '$sede', fecha = '$fecha' where f_desercion. numero_documento = '$valor'") or die ("problema en el registro". mysqli_error());
