...
$conexion=mysqli_connect("127.0.0.1","root","","proyecto") or die ("problemas en la conexion");
	 ...
	 $consulta=mysqli_query($conexion,"select * from f_desercion where numero_documento='$documento'") or die ("problema en el registro". mysqli_error());
...
<?php 
                     if ($documento!=$reg['numero_documento'] ||$documento== "" ) {
                     	...
                     	echo '<form action="buscar_desercion.php" method="post" >
...
<div class="con row justify-content-around ">
					<div class="col-4 " >
						<form action="buscar_desercion.php" method="post" >
							<h3>Buscar registro</h3>
							<input class="ar" type="search" name="doc" placeholder="numero documento">
							<input class="sm" type="submit" name="buscar" value="Buscar">	
						</form>	
					...
					<div class="col-4">
						<form action="filtrar_desercion.php" method="post" >
			...
			<div class="col">
				...
				<table class="table table-bordered table-striped table-hover table-reponsive">
					...
					<tr class=" bg-info">
						...
						if ($_SESSION['roles']!='invitado') 
						{
						echo'<td class="td"><a href="modificar_desercion.php"><input id="ip" type="button" value="Editar"></a> | <a href="eliminar_desercion.php"><input id="ipe" type="button" value="Eliminar"></a> </td>';
			     		}
						?>
