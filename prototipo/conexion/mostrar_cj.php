...
$conexion=mysqli_connect("127.0.0.1","root","","proyecto") or die ("problemas en la conexion");
	 ...
	 $consulta=mysqli_query($conexion,"select * from f_c_jornada where numero_documento='$documento'")or die ("problema en el registro". mysqli_error());
...
<?php 
                     if ($documento!=$reg['numero_documento'] ||$documento== "" ) {
                     	...
                     	echo '<form action="buscarcj.php" method="post" >
			...
			<div class="col">
				...
				<table class="table table-bordered table-striped table-hover table-reponsive">
					...
					<tr class="bg-info">
						...
						<?php if ($_SESSION['roles']!='invitado') 
						{
						echo'<td class="td"><a href="editarcambioj.php"><input id="ip" type="button" value="Editar"></a> | <a href="eliminar_cj.php"><input id="ipe" type="button" value="Eliminar"></a></td>';
					    }
					    ?>
