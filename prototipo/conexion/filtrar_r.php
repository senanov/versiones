...
$conexion=mysqli_connect("127.0.0.1","root","","proyecto") or die ("problemas en la conexion");
	 ...
	 $consulta=mysqli_query($conexion,"select * from f_retiro where $filtro='$palabra'")or die ("problema en el registro". mysqli_error());
		...
		<div class="row">
			...
			while ( $reg=mysqli_fetch_array($consulta)) 
			{
				...
				echo "<tr class='bg-info'>"
						...
						if ($_SESSION['roles']!='invitado')
						{
						 	echo'<td class="td"> <a href="editar_retiro.php?id='.$reg['numero_documento'].'"><input id="ip" type="button" value="Editar"></a> | </td>';						 	
