...
<?php 
                     if ($documento!=$reg['numero_documento'] ||$documento== "" ) {
                     	...
                     	echo '<form action="buscart.php" method="post" >
			...
			<div class="col">
				...
				<table class="table table-bordered table-striped table-hover table-reponsive">
					...
					<tr class=" bg-info">
						...
						<td><?php echo $reg['centro_actual']; ?></td>
						<td><?php echo $reg['centro_traslado']; ?></td>
						<td><?php echo $reg['ciudad_actual']; ?></td>
						<td><?php echo $reg['ciudad_traslado']; ?></td>
						...
						if ($_SESSION['roles']!='invitado')
						 {
						 echo'<td class="td"><a href="editar_traslado.php"><input id="ip" type="button" value="Editar"></a> | <a href="eliminart.php"><input id="ipe" type="button" value="Eliminar"></a></td>';
						 }
						 ?>
