...
$conexion=mysqli_connect("127.0.0.1","root","","proyecto") or die ("problemas en la conexion");
	 ...
	 $consulta=mysqli_query($conexion,"select * from f_traslado where $filtro='$palabra'")or die ("problema en el registro". mysqli_error());
...
<div class="con row justify-content-around ">
					<div class="col-4 " >
						<form  action="buscart.php" method="post" >
					...
					<div class="col-4">
						<form action="filtrar_t.php" method="post" >
		...
		<div class="row">
			...
			while ( $reg=mysqli_fetch_array($consulta)) 
			{
				...
				echo "<tr class='bg-info'>"
						...
						."<td>".$reg['trimestre'] ."</td>"
						."<td>".$reg['jornada'] ."</td>"
						."<td>".$reg['centro_actual'] ."</td>"
						."<td>".$reg['centro_traslado'] ."</br>"
						."<td>".$reg['ciudad_actual'] ."</td>"
						."<td>".$reg['ciudad_traslado'] ."</br>"
						...
						if ($_SESSION['roles']!='invitado')
						{
						 	echo'<td class="td"> <a href="editar_traslado.php?id='.$reg['numero_documento'].'"><input id="ip" type="button" value="Editar"></a> | </td>';						 	
