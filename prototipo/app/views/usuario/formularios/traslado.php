	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="" enctype="multipart/form-data" onsubmit="return validarFile();">
				...
				<label class="label-input100" for="nom1_form3">Ingresa los Nombres</label>
				<div class="wrap-input100 rs1-wrap-input100 validate-input">
					<input class="input100" type="text" placeholder="Primer Nombre *" name="nom1_form3" id="nom1_form3" required>
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 rs2-wrap-input100 validate-input">
					<input class="input100" type="text" placeholder="Segundo Nombre" name="nom2_form3" id="nombre2">
					<span class="focus-input100"></span>
				</div>
				...
				<label class="label-input100" for="centroa">Centro y Ciudad Actuales</label>
				<div class="wrap-input100 rs1-wrap-input100 validate-input">
					<input class="input100" type="text" placeholder="Centro Actual*" name="centroa" id="centroa" required>
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 rs2-wrap-input100 validate-input">
					<input class="input100" type="text" placeholder="Ciudad Actual*" name="ciudada" id="ciudada" required>
					<span class="focus-input100"></span>
				</div>	

				<label class="label-input100" for="centron">Centro y Ciudad de Traslado</label>
				<div class="wrap-input100 rs1-wrap-input100 validate-input">
					<input class="input100" type="text" placeholder="Centro de Traslado *" name="centron" id="centron" required>
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 rs2-wrap-input100 validate-input">
					<input class="input100" type="text" placeholder="Ciudad de Traslado *" name="ciudadn" id="ciudadn" required>
					<span class="focus-input100"></span>
				</div>						
