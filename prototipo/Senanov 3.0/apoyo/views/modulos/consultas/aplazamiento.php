...
<div class="con container">
 <div class=" row justify-content-around ">
 	<div class="col-4 ap" >
		<form method="post">
			...
			<input class="ar" type="search" name="docAplazamiento" placeholder="numero documento" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required><br><br>
 ...
 if (isset($_GET["id"])) 
 {
	$_POST["docAplazamiento"]=$_GET["id"];
 }

 $consulta = new Novedades();
 $consulta -> consultarAplazamientoController();
 $consulta -> eliminarAplazamientoController();
