...
<main role="main">
	...
	<section class="content-form">
		...
		<h2 class="sub-title">Formato de Aplazamiento Sena</h2>
		<?php
		$registro = new RegistrarNovedad();
		$registro -> aplazamientoController();
		?>
		...
		<form method="POST" id="registrar-form" >
			...
			<div class="form-group width-12">
				 <div class="width-6">
				  <input type="text" placeholder="Nombres del Aprendiz *" class="form-control" name="nom_aplazamiento" id="nombre" required/> 
				 </div> 
				 <div class="width-6">
