...
<div class="con container">
 <div class=" row justify-content-around ">
 	<div class="col-4 ap" >
		<form method="post">
			...
			<input class="ar" type="search" name="docTraslado" placeholder="numero documento" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required><br><br>
 ...
 if (isset($_SESSION['doc'])) {
  ...
  if (isset($_GET["id"]))
 {
	$_POST["docTraslado"]=$_GET["id"];
 }

 $consulta = new Novedades();
 $consulta -> consultarTrasladoController();
 $consulta -> eliminarTrasladoController();
