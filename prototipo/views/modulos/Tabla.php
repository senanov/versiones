...
class Tabla 
{
	...
	public static function reingreso_desercion($respuesta,$editar,$eliminar){
    ...
    return '<table class="table table-bordered table-striped table-hover table-reponsive">
					   ...
					   <tr class="bg-info"">
						...
						<td>'.$respuesta["fecha"].'</td>
                 		...
                 		<tr>
              	 		<td class="td" colspan="2"><center><a href="index.php?action='.$editar.'&idEditar='.$respuesta["documento"].'"><input id="ip" type="button" value="Editar"></a> | <a href="index.php?action='.$eliminar.'&doc='.$respuesta["documento"].'"><input id="ipe" type="button" value="Eliminar"></a></center></td>
         	 			</tr>
					  </table>';
    }

    public static function cambioJornada_aplazamiento_retiro($respuesta,$editar,$eliminar){
  ...
  public static function traslado($respuesta,$editar,$eliminar){
  ...
  return '<table class="table table-bordered table-striped table-hover table-reponsive">
	...
	#------------------------------------------------------------------------------------
	public static function editar_reingreso_desercion($respuesta){
	$novedad=$respuesta["tipo_novedad"];
    ...
    $tdocumento=$respuesta['tipo'];
    $ndocumento=$respuesta["documento"];
    $grupo=$respuesta["grupo"];
    $ficha=$respuesta["codigo_ficha"];
    $trimestre=$respuesta["numero_trimestre"];
    $jornada=$respuesta["tipo_jornada"];
    $programa=$respuesta["nombre_programa"];
    $sede=$respuesta["nombre_sede"];
    ...
    public static function editar_cambioJornada_aplazamiento_retiro($respuesta){
  ...
  public static function editar_traslado($respuesta){
