<nav class="navbar navbar-expand-lg ">
  ...
  <div class="collapse navbar-collapse "  id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php?enlace=consultar">¿Ya estoy registrado?</a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="index.php?enlace=pag_ayuda">¿Necesitas alguna ayuda?</a>
      </li>

      <li class="nav-item dropdown">
        <a class="nav-link"   href="index.php?enlace=servicios">
          Servicios
        </a>
      </li>
    </ul>
